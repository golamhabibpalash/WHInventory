            ...
            create: () => {
                qbGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'price', headerText: 'Price', width: 120, defaultValue: '0', format: 'N2', editType: 'numericedit', edit: { params: { decimals: 2, min: 0 } } },
                    ],
                    toolbar: [],
            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'fixedPrice', headerText: 'Fixed Price', width: 120, format: 'N2' },
                        { field: 'markupPercent', headerText: 'Markup %', width: 110 },
                        { field: 'marginPercent', headerText: 'Margin %', width: 110 },
                        { field: 'minimumSellingPrice', headerText: 'Min Price', width: 110, format: 'N2' },
