            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'pricePolicyName', headerText: I18n.t('customerGroup.pricePolicy'), width: 160 },
                        { field: 'description', headerText: I18n.t('common.description'), width: 350, minWidth: 200 },
                    ...
                    toolbarClick: async (args) => {
                        ...
                        if (args.item.id === 'AddCustom') {
                            ...
                            state.mainTitle = I18n.t('customerGroup.addTitle');
                            resetFormState();
                            mainModal.obj.show();
                        }
                        ...
                        if (args.item.id === 'EditCustom') {
                            ...
                            if (mainGrid.obj.getSelectedRecords().length) {
                                ...
                                state.mainTitle = I18n.t('customerGroup.editTitle');
                        ...
                        if (args.item.id === 'DeleteCustom') {
                            ...
                            if (mainGrid.obj.getSelectedRecords().length) {
                                const selectedRecord = mainGrid.obj.getSelectedRecords()[0];
                                state.mainTitle = I18n.t('customerGroup.deleteTitle');
                                state.id = selectedRecord.id ?? '';
                                state.name = selectedRecord.name ?? '';
                                state.description = selectedRecord.description ?? '';
                                state.pricePolicyId = selectedRecord.pricePolicyId ?? null;
