            ...
            create: async (dataSource) => {
                mainGrid.obj = new ej.grids.Grid({
                    ...
                    columns: [
                        ...
                        { field: 'defaultPrice', headerText: 'Default Price', width: 130, format: 'N2' },
                        { field: 'weightedAverageCost', headerText: 'WAC', width: 120, format: 'N2' },
                        { field: 'activePricePolicyName', headerText: 'Active Policy', width: 150 },
                        { field: 'activeFixedPrice', headerText: 'Policy Price', width: 130, format: 'N2' },
                        { field: 'margin', headerText: 'Margin', width: 110, format: 'N2' },
                        ...
                        { field: 'promotionalPrice', headerText: 'Promo Price', width: 130, format: 'N2' },
                    ],
